...
const App = () => {
    ...
    const renderContent = () => {
        switch (activeView) {
            ...
            case View.FAMILY: return <Family members={familyMembers} onAddMember={handlers.handleAddMember} onUpdateMember={handlers.handleUpdateMember} onDeleteMember={handlers.handleDeleteMember} onInviteMember={async () => { alert("Local only"); }} />;
