...
export interface TransactionSplit {
  ...
  isSettled?: boolean; // NEW: Controls if this specific credit is paid
...
export interface Transaction extends BaseEntity {
  ...
  // Settlement Logic (If I am the debtor)
  isSettled?: boolean; // NEW: Controls if my debt on this tx is paid
  settledAt?: string; // NEW
  settledByTxId?: string; // NEW: Links to the transaction that settled this
