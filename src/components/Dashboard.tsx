...
import { TrendingUp, TrendingDown, Bell, Clock, Wallet, PieChart as PieIcon } from 'lucide-react';
...
export const Dashboard: React.FC<DashboardProps> = ({ accounts, transactions, currentDate = new Date(), showValues, onEditRequest }) => {
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-safe">
            ...
            {/* Mobile: Horizontal Scroll Snap with peeking */}
            <div className="
            ...
            <Card className="hidden md:block border-slate-200 bg-white dark:bg-slate-900 dark:border-slate-800">
                <div className="flex items-center gap-2 mb-4 px-2">
                    ...
                    <h3 className="font-bold text-slate-800 dark:text-white">Fluxo de Caixa Anual</h3>
                </div>
            ...
            <Card className="border-slate-200 bg-white dark:bg-slate-900 dark:border-slate-800">
                <div className="flex items-center gap-2 mb-6">
                    ...
                    <div>
                        <h3 className="font-bold text-slate-800 dark:text-white text-base">Para onde foi o dinheiro?</h3>
                        <p className="text-xs text-slate-500 dark:text-slate-400">Análise de gastos por categoria</p>
                    </div>
                </div>
