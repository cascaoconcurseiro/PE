-- MIGRATION: ENABLE PERSONAL TRIP BUDGETS
-- DATE: 2025-01-09
-- DESCRIPTION: Modifies handle_trip_sharing to STOP synchronizing the 'budget' field on updates.
--              This allows invited users to set their own personal budget for the trip.
--              Initial creation still uses the inviter's budget as a starting point.
    ...
    LOOP
        ...
        IF target_user_id IS NOT NULL THEN
            ...
            IF existing_mirror_id IS NOT NULL THEN
                ...
                -- CRITICAL CHANGE: WE DO NOT UPDATE 'budget' HERE.
                UPDATE trips SET 
            ...
            ELSE
                -- NEW MIRROR: Insert with initial budget (optional, or start at 0?)
                -- Let's copy the initial budget as a suggestion/default.
