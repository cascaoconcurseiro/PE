-- ==============================================================================
-- MIGRATION: STRICT TYPING & INTEGRITY v4 (2026-01-06)
-- DESCRIPTION: Converts TEXT links to UUID Foreign Keys.
-- FIX 1: Removed RAISE NOTICE.
-- FIX 2: Uses 'DISABLE TRIGGER USER' instead of 'ALL' to avoid permission errors.
-- ==============================================================================

BEGIN;

-- 1. DISABLE USER TRIGGERS (Safety Mode - Non-Superuser Friendly)
-- This stops 'handle_mirror' and 'update_balance' but keeps FK checks active.
