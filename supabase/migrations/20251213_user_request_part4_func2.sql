    ...
    LOOP
        ...
        IF target_user_id IS NOT NULL THEN
            ...
            IF (TG_OP = 'INSERT') THEN
                ...
                -- Nota: Como não temos acesso garantido a extensões como pg_trgm, a flag de duplicidade
                -- será marcada apenas se a descrição for alterada para indicar isso OU usaremos uma coluna se existir.
                -- Neste schema, optamos por adicionar sufixo na descrição se for duplicado, para não depender de coluna.
