-- ==============================================================================
-- MIGRATION: STRICT TYPING & INTEGRITY (2026-01-06)
-- DESCRIPTION: Converts TEXT links to UUID Foreign Keys and adds Safety Checks.
-- ==============================================================================

BEGIN;

-- ==============================================================================
-- 1. SANITIZE DATA (Prepare for Casting)
-- ==============================================================================
...
-- This assumes we prefer to KEEP the transaction (unlinked) rather than delete it.
...
-- ==============================================================================
-- 2. APPLY STRICT TYPES ( The "Iron Dome" )
-- ==============================================================================
...
-- Ensure Amounts don't have infinite precision errors (Soft check, Postgres handles numeric well, 
-- but ensuring not 0 for some cases might be useful? No, 0 is valid).
-- Let's ensure Date is not future + 100 years (Sanity check)
ALTER TABLE public.transactions
...
-- ==============================================================================
-- 4. NEW MODULE: AUDIT LOGS (Who changed what?)
-- ==============================================================================
