-- ==============================================================================
-- MIGRATION: STRICT TYPING & INTEGRITY v2 (2026-01-06)
-- DESCRIPTION: Converts TEXT links to UUID Foreign Keys.
-- FIX: Disables triggers during update to prevent type mismatch errors in logic.
-- ==============================================================================
...
-- ==============================================================================
RAISE NOTICE 'Sanitizing textual garbage...';
...
-- Using strict casting logic to avoid "uuid = text" issues in potential sub-selects if any context leaks.
-- We cast both to text to be safe.
...
-- ==============================================================================
RAISE NOTICE 'Converting columns to UUID...';
...
ALTER TABLE public.transactions 
    DROP CONSTRAINT IF EXISTS chk_transaction_type; -- Drop if exists from partial run
ALTER TABLE public.transactions 
