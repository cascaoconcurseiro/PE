...
export const TransactionForm: React.FC<TransactionFormProps> = ({
    ...
    return (
        <div className="flex flex-col h-full bg-white dark:bg-slate-900 relative">
            ...
            {/* Header Tabs */}
            <div className="sticky top-0 px-3 py-1.5 shrink-0 border-b border-slate-100 dark:border-slate-700 flex items-center gap-2 bg-white dark:bg-slate-900 z-30">
